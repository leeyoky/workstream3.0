  ...
  return (
    <div className={classes['emp-list__result']}>
      <div className={classes['emp-item-wrapper']}>
                ...
                {referenceDept.map((dept, index) => (
                  <>
                    ...
                    <i className="fa-solid fa-folder"></i>
                      {dept.deptNm}
                      <button onClick={()=> deleteRefHandler('DEPT', dept.deptCd)}><i className="fa-solid fa-xmark"></i></button>
                    </span>
                  </>
                ))}
              </div>
              ) : (
                <strong className={classes['emp-item__drag']}>
                  부서를 추가(+) 해주세요 </strong>
              )}
            </div>
          </div>
        ...
        <div className ={classes['emp-index-default']}> 
          <div className={classes['emp-index--ref']}>
            <div className={classes['reference-item--emp']} 
              onDragOver={handleDragOver}
              onDrop={handleDrop}
              >
