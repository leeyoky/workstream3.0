...
const ResinationCreate = () => {
  ...
  const { mobilePhone, homePhone, mobilePhoneChangeHandler, homePhoneChangeHandler } =
    usePhoneValidation();
  ...
  /* 최종 사인 */
  const onSign = () => {
    const confirmMsg = window.confirm('준수사항을 확인하셨습니까?');
    if (confirmMsg) {
          ...
          <table className={classes['header-info']}>
            <thead>
              <tr>
                ...
                <td colSpan={2}>{userInfo.rankNm}</td>
              </tr>
              <tr>
                <th>성 명</th>
                <td colSpan={2}>{userLoginInfo?.empNm}</td>
                <th>주민 번호</th>
              ...
              <tr>
                <th>입사 일자</th>
                <td colSpan={2}>{formData.enterDate}</td>
                <th>퇴사 일자</th>
                <td colSpan={2} className={classes['update-input']}>
                  {DatePickMemoized}
                </td>
                ...
                <td>
                  <div className={classes['text-wrapper']}>
                    <div>
                      ...
                      <p>
                        ② 상기자 본인은 부정경쟁방지법 제11조 및 12조의 규정과 회사의 비밀 관리
                        규정을 준수하여, 근무 중 인지한 경영, 재정, 영업, 기술, 마케팅 등
                        <br />
                  ...
                  <div className={classes['user-sign']}>
                    <div className={classes['user-sign-box']}>
                      ...
                      <button onClick={onSign} type="button">
                        서명
                      </button>
                    </div>
                  </div>
